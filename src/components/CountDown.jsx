...
let CountDown = () => {
  ...
  const [timeTillLaunch, setTimeTillLaunch] = useState(
  ...
  const [launchTimeInfo, setLaunchTimeInfo] = useState({
    ...
    hour: Math.floor(
      (timeTillLaunch % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60)
    ),
    ...
    setTimeout(() => {
      if (timeTillLaunch > 0) {
        setLaunchTimeInfo({
          ...
          minutes: Math.floor(
            (timeTillLaunch % (1000 * 60 * 60)) / (1000 * 60)
          ),
          seconds: Math.floor((timeTillLaunch % (1000 * 60)) / 1000),
        });
            ...
            <>
              ...
              <div className="grid md:grid-cols-4 grid-cols-2 md:my-20 my-10 md:w-[70%] mx-auto">
                <div className="flex items-center flex-col ">
                  <div className="rounded bg-dark-gray w-[70%] flex shadow-xl justify-center items-center h-[150px] text-white text-7xl">
                    <h1>{launchTimeInfo.day}</h1>
                  </div>
                  Days
                </div>
                <div className="flex items-center flex-col ">
                  <div className="rounded bg-dark-gray w-[70%] flex shadow-xl justify-center items-center h-[150px] text-white text-7xl">
                    <h1>{launchTimeInfo.hour}</h1>
                  </div>
                  Hours
                </div>
                <div className="flex items-center flex-col ">
                  <div className="rounded bg-dark-gray w-[70%] flex shadow-xl justify-center items-center h-[150px] text-white text-7xl">
                    <h1>{launchTimeInfo.minutes}</h1>
                  </div>
                  Minutes
                </div>
                <div className="flex items-center flex-col ">
                  <div className="rounded bg-dark-gray w-[70%] flex shadow-xl justify-center items-center h-[150px] text-white text-7xl">
                    <h1>{launchTimeInfo.seconds}</h1>
                  </div>
                  Seconds
                </div>
              </div>
              <div className="text-center">
                Launch date will be: {launchTimeInfo.staticLaunchDate}
              </div>
            </>
          ) : (
            <>
              ...
              <div className="text-center">
                Launch date was: {launchTimeInfo.staticLaunchDate}
              </div>
            </>
          )}
        </div>
