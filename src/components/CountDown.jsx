...
let CountDown = ()=> {
    ...
    let launchDate = new Date(`December 31, ${new Date().getFullYear()} 23:59:59`).getTime()
...
<>
        ...
        <div className="text-center">Launch date will be: {launchTimeInfo.staticLaunchDate}</div>
        </>
        :
        <>
                <div className="mt-12 md:mt-0" aria-label="header">
            ...
            <div className="grid md:grid-cols-4 grid-cols-2 md:my-20 my-10 md:w-[70%] mx-auto">
            <div className="flex items-center flex-col ">
            <div className="rounded bg-dark-gray w-[70%] flex shadow-xl justify-center items-center h-[150px] text-white text-7xl"><h1>-</h1></div>
                Days
            </div>
            <div className="flex items-center flex-col ">
            <div className="rounded bg-dark-gray w-[70%] flex shadow-xl justify-center items-center h-[150px] text-white text-7xl"><h1>-</h1></div>
        ...
        <div className="text-center">Launch date was: {launchTimeInfo.staticLaunchDate}</div>
        </>
}
            </div>
            </div>
